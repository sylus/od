...
use Drupal\od\Extender;
use Drupal\od\FormHelper;
use Symfony\Component\DependencyInjection\ContainerInterface;

/**
 * Defines a form for selecting which Open Data extensions to install.
 */
class ExtensionSelectForm extends FormBase {

  /**
   * The Open Data extender configuration object.
   *
   * @var \Drupal\od\Extender
   */
  protected $extender;
   ...
   *
   * @param \Drupal\od\Extender $extender
   *   The Open Data extender configuration object.
   * @param string $root
   *   The Drupal application root.
   ...
   * @param \Drupal\od\FormHelper $form_helper
   *   The form helper.
   */
  ...
  public static function create(ContainerInterface $container) {
    return new static(
      $container->get('od.extender'),
      $container->get('app.root'),
      $container->get('info_parser'),
      $container->get('string_translation'),
      $container->get('od.form_helper')
    );
  }
  ...
  /**
   * Yields info for each of Open Data's extensions.
   */
  ...
  public function buildForm(array $form, FormStateInterface $form_state, array &$install_state = NULL) {
    ...
    if (is_array($chosen_ones)) {
      ...
      // Explain ourselves.
      $form['help']['#markup'] = $this->t("Open Data extensions have been pre-selected in the od.extend.yml file in your sites directory and are disabled here as a result.");
    }
    else {
      $form['help']['#markup'] = $this->t("You can choose to disable some of Open Data's functionality below. However, it is not recommended.");
    }
  ...
  /**
   * Forces the Open Data Core extension to be selected.
   *
   * Turns the Open Data Core checkbox into a persistent server-side value so
  ...
  public static function requireCore(array $element) {
    $element['od_core'] = [
      '#type' => 'value',
      '#value' => $element['od_core']['#return_value'],
    ];
    return $element;
  }
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $GLOBALS['install_state']['od']['modules'] = array_merge($modules, $this->extender->getModules());
  }
