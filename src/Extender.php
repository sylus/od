...
/**
 * Helper class to get information from a site's od.extend.yml file.
 */
class Extender {
  ...
  public function getInfo() {
    // Discover od.extend.yml first in the `sitePath`, and then defer to
    // `sites/all`.
    $paths[] = $this->sitePath . '/od.extend.yml';
    $paths[] = $this->root . '/sites/all/od.extend.yml';
  ...
  /**
   * Returns the list of Open Data Extensions to enable.
   *
   * @return string[]
  ...
  public function getOpenDataExtensions() {
    ...
    return isset($info['od_extensions']) ? $info['od_extensions'] : FALSE;
  }
